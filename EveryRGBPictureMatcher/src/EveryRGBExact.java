...
public class EveryRGBExact extends RenderableObject
	{
		// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		// ~~~~~~~~~~~~~~~~~~~~~~~~ Constant Variables ~~~~~~~~~~~~~~~~~~~~~~~~~~~
		// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		public final void tick(double secondsPassed)
			{
				...
				for (int x = X; x < IMG_SIZE; x++)
					for (int y = Y; y < IMG_SIZE; y++)
						{
							// calculate the current fitness of the two pixels
							int oldDifference = getDifference(x, y, x, y) + getDifference(X, Y, X, Y);
							// calculate the fitness if the pixels were swapped
							int newDifference = getDifference(x, y, X, Y) + getDifference(X, Y, x, y);
		 ...
		 * 
		 * @param x
		 *            - the x index of the pixels
		 * @param y
		 *            - the y index of the pixels
		 * 
		 ...
		 * 
		 * @param x1
		 *            - the x coordinate for the first pixel
		 * @param y1
		 *            - the y coordinate for the first pixel
		 * @param x2
		 *            - the x coordinate for the second pixel
		 * @param y2
		 *            - the y coordinate for the second pixel
		 */
